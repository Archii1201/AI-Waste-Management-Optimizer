...
from sqlalchemy import Boolean, CheckConstraint, DateTime, Float, Integer, String, Time
...
class Vehicle(Base, TimestampMixin):
    ...
    accepted_waste_types: Mapped[list[str] | None] = mapped_column(JSONB, nullable=True)
